...
(function ($) {
    ...
    var DanmuPlayer = function (element, options) {
        ...
        $("body").append('<div id="' + this.id.slice(1, this.id.length) + 'fontTip"  hidden="true">' +
            ...
            '<form  id="danmu-size" >Size：<input   type="radio" checked="checked"  name="danmu_size" value="1" />Large Text&nbsp;&nbsp;' +
            '<input   type="radio" name="danmu_size" value="0" />Small Text&nbsp;&nbsp;</form>' +
